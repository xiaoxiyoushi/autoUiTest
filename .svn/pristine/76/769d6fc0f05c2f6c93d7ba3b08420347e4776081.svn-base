...
public class EBFA02确认入库_个人简评_校验数据 extends BoleBase {
    ...
    public void test ()throws IllegalAccessException, InstantiationException, InterruptedException, InvocationTargetException {
        ...
        EB0301Page eB0301Page=(EB0301Page)eBFA08Page.checkResume_personalIntroduce(personalIntroduce).clickSpan("生成推荐报告").sleepForSeconds(1)//点击 生成推荐报告
                .Span_Value("生成推荐报告成功")//框架上 提示生成推荐报告成功
                .clickLi("推荐报告").sleepForSeconds(2)//切换 推荐报告栏

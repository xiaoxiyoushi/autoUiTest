...
public class Public<T extends Public> extends UIPage<T> {
    ...
    public T i_classClick(String str) {
        this.findByXPath("//i[@class=\""+str+"\"]").click();
        return (T) this;
    }
    ...
    //#GPPL04_bg > div.detailsTable.ivu-table-wrapper > div > div.ivu-table-fixed-right > div.ivu-table-fixed-body > table > tbody > tr:nth-child(1) > td:nth-child(1) > div > div > span
    ////*[@id="GPPL04_bg"]/div[4]/div/div[4]/div[2]/table/tbody/tr[1]/td[1]/div/div/span
    //*[@id="GPPL04_bg"]/div[4]/div/div[4]/div[2]/table/tbody/tr[1]/td[1]/div/div/a
    ...
    //有多个表格，获取span值
    public String table_td_spanValue(int n,int tr_numb,int td_numb,int m){
        String td_Value=this.findListByClassName("ivu-table-tbody").get(n)
                .findListByTagName("tr").get(tr_numb)
                .findListByTagName("td").get(td_numb)
                .findByTagName("span").getText();

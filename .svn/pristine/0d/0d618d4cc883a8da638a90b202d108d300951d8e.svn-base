...
//张召峰
public class EBFA02确认入库_附加信息_校验数据 extends BoleBase {
    @Test
    public void test ()throws IllegalAccessException, InstantiationException, InterruptedException, InvocationTargetException {
        ...
        String name="张召峰"+randomStr;
        String phone="18895808140"+randomStr;
        String mailbox="2004014091@163.com"+randomStr;
        String companyName="扬州咸鸭蛋公司"+randomStr;
        String extraInform="附加信息"+randomStr;
        String mustKeywords = "18795808140";

        EBFA02Page eBFA02Page = (EBFA02Page) eBFA04Page
                .sendInputPlaceholder("请输入必须包含的关键词,用空格隔开", mustKeywords)

                .sendInputPlaceholder("多个公司名称用空格隔开","南京汇沪电气有限公司")
        ...
        eB0301Page.checkRecommendation_addInform(extraInform);//获取到 项目经历的值，就验证成功
    }
}

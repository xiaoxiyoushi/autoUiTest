...
public class EBFA01上传简历_校验解析出的简历 extends BoleBase {
   /* @Test
    public void 校验右侧展示原始简历 ()throws IllegalAccessException, InstantiationException, InterruptedException {
        ...
        eBFA01Page.judgeWay()
                .uploadResume("C:\\Users\\86182\\Desktop\\resume\\6-51job_钱程.doc").sleepForSeconds(3)//.docx文件
                .sleepForSeconds(1);
        eBFA01Page.inputValue();
    }*/
}

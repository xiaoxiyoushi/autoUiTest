...
public class EBFA08人选详情_可能包含关键词 extends BoleBase {
    @Test
    public void test ()throws IllegalAccessException, InstantiationException, InterruptedException {
        ...
        EBFA08Page eBFA08Page=(EBFA08Page)eBFA03Page.sendInputPlaceholder("请输入可能包含的关键词,用空格隔开",mustKeywords)
        ...
        eBFA08Page.clickSpan("展开更多").sleepForSeconds(1)
                .checkInform_yellow(list,0)//人选卡片
                .checkInform_yellow(list,1).sleepForSeconds(2);//简历详情

...
public class 寻找人选_0_关键字 extends HunterBase {
    @Test
    public void 搜索关键字程序员() throws IllegalAccessException, InstantiationException, InterruptedException {
        ...
        CandidateResultPage resultPage = (CandidateResultPage) findCandidatePage.keywords("程序员")
                .clickSearch().sleepForSeconds(1).transfer(CandidateResultPage.class).sleepForSeconds(1);

           resultPage.assertHasResults().keywords("java程序员").clickSearch()
                .sleepForSeconds(1);
    }
}

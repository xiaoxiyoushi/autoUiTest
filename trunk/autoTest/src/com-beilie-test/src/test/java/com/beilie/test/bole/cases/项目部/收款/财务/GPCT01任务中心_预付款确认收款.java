package com.beilie.test.bole.cases.项目部.收款.财务;
...
public class GPCT01任务中心_预付款确认收款 extends BoleBase {
    ...
    public void test() throws IllegalAccessException, InstantiationException, InterruptedException {
        ...
        GP38Page gP38Page = (GP38Page) gPCT01Page.task("//div[@class=\"tashList_list\"]/div[10]//i").sleepForSeconds(1)//预付款审核的父菜单  点击箭头 展示子菜单

package com.beilie.test.bole.cases.收款.合约专员;

import com.beilie.test.bole.core.BoleBase;
import com.beilie.test.bole.pages.BdHomePage;
import com.beilie.test.bole.pages.GP.GPAT.GPAT06Page;
...
public class GPCT01任务中心_预付款审核_通过 extends BoleBase {
    ...
    public void test() throws IllegalAccessException, InstantiationException, InterruptedException {
        ...
        GPAT06Page gPAT06Page = (GPAT06Page) gPCT01Page.firstTask("预付款收款")//预付款审核的父菜单  点击箭头 展示子菜单

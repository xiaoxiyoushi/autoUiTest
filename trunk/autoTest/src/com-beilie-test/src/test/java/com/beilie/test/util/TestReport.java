...
public class TestReport implements IReporter {
    ...
    private String path = System.getProperty("user.dir") + File.separator +"ztest-master"+ File.separator+reportdate+ "ui-report.html";
    // 定义html样式模板所在路径
    private String templatePath = System.getProperty("user.dir") + File.separator + "ztest-master//template";
    ...
    public TestReport() {
        ...
        name = "伯乐ui自动化测试";
        //name = "ttt"+formatter.format(System.currentTimeMillis());
    }

...
public class EBFA03人选搜索_人选搜索结果_添加标签 extends BoleBase {
    @Test(description = "加标签并且验证")
    public void 搜索结果() throws IllegalAccessException, InstantiationException, InterruptedException {
        ...
        String tagValue=eBFA03Page.waitCandidateSearchResults()
                .addTag();
        ...
        eBFA03Page.assertLabel(tagValue);

...
public class 寻找人选_6_组合搜索_关键词_职位名称 extends HunterBase{
    @Test
    public void 组合搜索关键词_职位名称() throws IllegalAccessException, InstantiationException, InterruptedException {
        ...
        CandidateResultPage resultPage = (CandidateResultPage) findCandidatePage.keywords("女").positionName("会计")
                .clickSearch().sleepForSeconds(1).transfer(CandidateResultPage.class).sleepForSeconds(10);
    }
}

...
public class EBFA05我的人才库_我的分组_文案 extends BoleBase {
    @Test(description = "我的分组_文案")
    public void 文案 ()throws IllegalAccessException, InstantiationException, InterruptedException {

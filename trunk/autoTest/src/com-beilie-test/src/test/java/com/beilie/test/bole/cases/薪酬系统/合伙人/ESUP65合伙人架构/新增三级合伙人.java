...
public class 新增三级合伙人 extends BoleBase {
    @Test(description = "新增")
    public void test() throws IllegalAccessException, InstantiationException, InterruptedException {
        ...
        eSUP65Page.copartner_input("copartnerName_placeholder", "levelThreeCopartnerName")
                .sleepForSeconds(1)
                // .leftScroll()
                .addLevelOneCopartner("朱颜3033", "3").sleepForSeconds(1)
                .assertAdd()
        ;
    }
}

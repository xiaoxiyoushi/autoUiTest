...
import com.beilie.test.bole.pages.EB.*;
import com.beilie.test.open.PublicClass.Public;
import org.junit.Test;
import java.lang.reflect.InvocationTargetException;

public class EBFA02确认入库_加入项目 extends BoleBase {
    @Test
    public void test ()throws IllegalAccessException, InstantiationException, InterruptedException, InvocationTargetException {
        ...
        eBFA01Page.judgeWay()
                .uploadResume("C:\\Users\\86182\\Desktop\\resume\\张德年.txt").sleepForSeconds(3)//.txt文件
                .sleepForSeconds(4);

        BdHomePage bdHomePage_1 = (BdHomePage)eBFA01Page.switchOutIframe(BdHomePage.class);

        EBFA04Page eBFA04Page = (EBFA04Page) bdHomePage_1
                .clickSingleMenu("简历搜索")//点击菜单栏
        ...
        String name="张德年"+randomStr;
        String phone="18012558122"+randomStr;
        String mailbox="denianzhang@outlook.com"+randomStr;
        ...
        EBFA02Page eBFA02Page=(EBFA02Page)eBFA04Page
                ...
                .sendInputPlaceholder("多个公司名称用空格隔开","上海易纵仪器责任发展有限公司")
        ...
        eBFA04Page_1.addProject_click().sleepForSeconds(1)
        .Span_Value("该人选当前正在本职位操作中，无法重复添加。");//获取到该元素 ，就验证成功

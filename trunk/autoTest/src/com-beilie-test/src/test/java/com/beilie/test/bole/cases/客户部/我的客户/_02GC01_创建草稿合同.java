...
public class _02GC01_创建草稿合同 extends BoleBase {
    @Test(description="测试将合同创建出来")
    public void 创建草稿合同 ()throws IllegalAccessException, InstantiationException, InterruptedException {
        BdHomePage bdHomePage = login("bd_userName", "bd_password").sleepForSeconds(3);

        bdHomePage.closeHideMenue();//关闭设置隐藏菜单的弹窗
        GCCM02Page gCCM02Page=(GCCM02Page)bdHomePage
                .clickFirstMenu_clientManage().sleepForSeconds(1)
                .clickSecondMenu_myClient()
                .switchToNewIframe1("GCCM02",GCCM02Page.class).sleepForSeconds(2);

        GC01Page gc01Page=(GC01Page)gCCM02Page
                  .clickProtectInput()
...
//                          .switchToNewIframe(0,GC01Page.class).sleepForSeconds(1);//跳到GC01客户详情-基本信息页面；
        ...
        GC11Page gC11Page=(GC11Page)gc01Page
                .clickEdit()//点击【编辑】
        ...
        gc01Page3.clickSpan("新增合同").sleepForSeconds(2);
    }
}

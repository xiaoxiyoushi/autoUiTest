...
public class GP10项目详情_从备选库添加_弹窗里的加入项目按钮禁用 extends BoleBase {
    @Test
    public void test ()throws IllegalAccessException, InstantiationException, InterruptedException,Exception {
        ...
        gP10Page.alternativeLibraryBtn_click().sleepForSeconds(1)
                .alternativeLibrary_joinProje_isEnabled();

...
import com.beilie.gaohr.config.ProjectStatus;
import com.beilie.gaohr.contract.GPService;
import com.beilie.gaohr.entity.VGPPM01_TeamProject;
...
public class GP10项目详情_关闭职位 extends BoleBase {
    @Test
    public void test() throws IllegalAccessException, InstantiationException, InterruptedException, Exception {
        ...
        GPPM10Page gPPM10Page_1 = (GPPM10Page) gP10Page
                ...
                .divClass("ivu-dropdown-rel").sleepForSeconds(1)
                /*.Li_click("关闭\n" +
                        "              ")*/
                .ulClass_li("ivu-dropdown-menu",3)
        ...
        gC18Page.Li_click("职位概览").sleepForSeconds(2)
                .checkPositionStatus(positionName,"已关闭").sleepForSeconds(2);
